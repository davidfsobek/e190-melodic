...
set(MSG_I_FLAGS "-Ie190_bot:/home/dsobek/Projects/e190melodic_ws/src/e190_bot/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/dsobek/Projects/e190melodic_ws/src/e190_bot/msg/ir_sensor.msg" NAME_WE)
add_custom_target(_e190_bot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "e190_bot" "/home/dsobek/Projects/e190melodic_ws/src/e190_bot/msg/ir_sensor.msg" ""
)
...
_generate_msg_cpp(e190_bot
  "/home/dsobek/Projects/e190melodic_ws/src/e190_bot/msg/ir_sensor.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/e190_bot)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/e190_bot\")")
  # install generated code
  install(
